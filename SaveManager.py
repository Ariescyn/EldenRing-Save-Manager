...
def rename_slot():
    ...
    y = root.winfo_y()
    popupwin.geometry("+%d+%d" %(x+200,y+200))
    but_done = Button(popupwin, text='Done', borderwidth=5, width=6, command=done).grid(row=2, column=0, padx=(25,65), pady=(0,15), sticky='w')
    but_cancel = Button(popupwin, text='Cancel', borderwidth=5, width=6, command=cancel).grid(row=2, column=0, padx=(70,0), pady=(0,15))
